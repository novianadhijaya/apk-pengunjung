                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <div class="pull-right">
                                <a href="<?php echo site_url('laporan/pengujian_excel'); ?>" class="btn btn-success btn-sm">
                                    <i class="fa fa-file-excel-o"></i> Excel
                                </a>
                                <a href="<?php echo site_url('laporan/pengujian_pdf'); ?>" class="btn btn-danger btn-sm">
